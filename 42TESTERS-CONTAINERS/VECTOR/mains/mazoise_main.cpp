...
/*   Updated: 2022/06/15 16:46:42 by efrancon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	resize_tests<int>();				// false
	// insert_tests<int>();				// false
	// reserve_tests<int>();				// false
	// copy_swap_tests<int>();				// false
	// reverse_it_tests<int>();				// ok
