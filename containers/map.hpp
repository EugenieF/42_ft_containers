...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/21 10:55:41 by efrancon          #+#    #+#             */
/*   Updated: 2022/06/21 11:17:12 by efrancon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class map
	{
		...
		private:
			typedef ft::red_black_tree<value_type, allocator_type, value_compare>	tree_type;
